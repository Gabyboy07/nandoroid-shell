...
Flickable {
    ...
    readonly property var basicColors: [
        ...
        { name: "Ayu", file: "ayu.json", colors: ["#ffb454", "#39bae6", "#f07178"], isDark: true },
        ...
        { name: "Dracula", file: "dracula.json", colors: ["#bd93f9", "#50fa7b", "#8be9fd"], isDark: true },
        ...
        { name: "Gruvbox", file: "gruvbox.json", colors: ["#fab387", "#f9e2af", "#f5e0dc"], isDark: true },
        { name: "Kanagawa", file: "kanagawa.json", colors: ["#7e9cd8", "#7fb4ca", "#957fb8"], isDark: true },
        ...
        { name: "Rose Pine", file: "rose_pine.json", colors: ["#c4a7e7", "#eb6f92", "#31748f"], isDark: true },
