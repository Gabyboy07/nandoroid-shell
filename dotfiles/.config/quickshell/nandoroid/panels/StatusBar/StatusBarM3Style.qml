...
Item {
    ...
    Rectangle {
        ...
        M3StatusWrapper {
            ...
            Layout.maximumWidth: rootM3.isCentered ? (rootM3.centeredWidth * (leftSysMonWrapper.visible ? 0.10 : 0.25)) : Math.min((leftSysMonWrapper.visible ? 180 : 350) * Appearance.effectiveScale, rootM3.width * (leftSysMonWrapper.visible ? 0.12 : 0.25))
            ...
            ActiveWindowTitle {
                ...
                Layout.alignment: Qt.AlignVCenter
                Layout.maximumWidth: rootM3.isCentered ? (rootM3.centeredWidth * (leftSysMonWrapper.visible ? 0.10 : 0.25)) : Math.min((leftSysMonWrapper.visible ? 180 : 350) * Appearance.effectiveScale, rootM3.width * (leftSysMonWrapper.visible ? 0.12 : 0.25))
                maxWidth: rootM3.isCentered ? (rootM3.centeredWidth * (leftSysMonWrapper.visible ? 0.10 : 0.25)) : Math.min((leftSysMonWrapper.visible ? 180 : 350) * Appearance.effectiveScale, rootM3.width * (leftSysMonWrapper.visible ? 0.12 : 0.25))
    ...
    Rectangle {
        ...
        M3StatusWrapper {
            ...
            m3Color: Appearance.m3colors.m3secondaryContainer
            m3ContentColor: Appearance.m3colors.m3onSecondaryContainer
            Layout.maximumWidth: rootM3.isCentered ? (rootM3.centeredWidth * (rightSysMonWrapper.visible ? 0.10 : 0.25)) : Math.min((rightSysMonWrapper.visible ? 180 : 350) * Appearance.effectiveScale, rootM3.width * (rightSysMonWrapper.visible ? 0.12 : 0.25))
            ...
            ActiveWindowTitle {
                ...
                Layout.alignment: Qt.AlignVCenter
                Layout.maximumWidth: rootM3.isCentered ? (rootM3.centeredWidth * (rightSysMonWrapper.visible ? 0.10 : 0.25)) : Math.min((rightSysMonWrapper.visible ? 180 : 350) * Appearance.effectiveScale, rootM3.width * (rightSysMonWrapper.visible ? 0.12 : 0.25))
                maxWidth: rootM3.isCentered ? (rootM3.centeredWidth * (rightSysMonWrapper.visible ? 0.10 : 0.25)) : Math.min((rightSysMonWrapper.visible ? 180 : 350) * Appearance.effectiveScale, rootM3.width * (rightSysMonWrapper.visible ? 0.12 : 0.25))
                monitor: rootM3.monitor
